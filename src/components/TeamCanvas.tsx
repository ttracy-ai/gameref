...
const PRESET_ROLES = [
  // Most common first — these get the most differentiated colors
  "Programmer",
  "2D Artist",
  "3D Artist",
  "Character Artist",
...
const ROLE_COLOR_MAP: Record<string, RoleColor> = {
  // ── Top 8 — spread ~45° apart on the hue wheel for maximum distinction ──────
  "Programmer":           { accent: "#1d4ed8", bg: "#dbeafe", text: "#1e3a8a" },   // 225° blue
  "2D Artist":            { accent: "#6d28d9", bg: "#ede9fe", text: "#4c1d95" },   // 270° violet
  "3D Artist":            { accent: "#a21caf", bg: "#fdf4ff", text: "#701a75" },   // 305° fuchsia
  "Character Artist":     { accent: "#e11d48", bg: "#ffe4e6", text: "#881337" },   // 350° rose-red
  "Game Designer":        { accent: "#047857", bg: "#d1fae5", text: "#064e3b" },   // 160° emerald
  "Level Designer":       { accent: "#4d7c0f", bg: "#ecfccb", text: "#365314" },   // 95°  lime
  "Writer":               { accent: "#b45309", bg: "#fef3c7", text: "#78350f" },   // 38°  amber
  "Sound Designer":       { accent: "#0e7490", bg: "#cffafe", text: "#164e63" },   // 190° cyan

  // ── Remaining — alphabetical, fill in the gaps ────────────────────────────
  "Animator":             { accent: "#c2410c", bg: "#ffedd5", text: "#7c2d12" },   // orange
  "Composer / Musician":  { accent: "#4338ca", bg: "#e0e7ff", text: "#312e81" },   // indigo
  "Concept Artist":       { accent: "#be185d", bg: "#fce7f3", text: "#831843" },   // pink
  "Project Manager":      { accent: "#0369a1", bg: "#e0f2fe", text: "#0c4a6e" },   // sky
  "QA Tester":            { accent: "#b91c1c", bg: "#fee2e2", text: "#7f1d1d" },   // red
  "UI / UX Designer":     { accent: "#7c3aed", bg: "#f5f3ff", text: "#5b21b6" },   // purple
  "VFX Artist":           { accent: "#a16207", bg: "#fefce8", text: "#713f12" },   // yellow
  "Voice Actor":          { accent: "#15803d", bg: "#dcfce7", text: "#14532d" },   // green
};
